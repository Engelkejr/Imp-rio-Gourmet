  ...
  const conf = [
    ...
    { t: 'e', n: 'SORTE OU<br>REVÉS', g: '1/3' },
    { t: 'p', n: 'Dogão do Bigode', pr: 60, al: [4, 20, 60, 150], up: 50, c: 'var(--c-brown)', g: '1/4' },
    { t: 'x', n: 'Alvará Prefeita', val: 200, g: '1/5' },
    ...
    { t: 'c', n: 'Vigilância<br>Sanitária', g: '1/11' },
    ...
    { t: 'e', n: 'SORTE OU<br>REVÉS', g: '8/11' },
    ...
    { t: 'e', n: 'SORTE OU<br>REVÉS', g: '11/9' },
    ...
    { t: 'p', n: 'Uéber Eats', pr: 200, al: [25, 50, 100, 200], up: 0, c: 'var(--c-special)', g: '11/6' },
    { t: 'p', n: 'OutBeck', pr: 260, al: [22, 110, 330, 800], up: 150, c: 'var(--c-yellow)', g: '11/5' },
    { t: 'p', n: 'Coco Bambolê', pr: 260, al: [22, 110, 330, 800], up: 150, c: 'var(--c-yellow)', g: '11/4' },
    { t: 'p', n: 'Viño sol', pr: 150, al: [15, 30, 60, 120], up: 0, c: 'var(--c-special)', g: '11/3' },
    { t: 'p', n: 'Brasa de teto', pr: 280, al: [24, 120, 360, 850], up: 150, c: 'var(--c-yellow)', g: '11/2' },
    { t: 'c', n: 'Inspeção', g: '11/1' },
    ...
    { t: 'e', n: 'SORTE OU<br>REVÉS', g: '8/1' },
    { t: 'p', n: 'Mistreal', pr: 320, al: [28, 150, 450, 1000], up: 200, c: 'var(--c-green)', g: '7/1' },
    { t: 'p', n: 'José Entregas', pr: 200, al: [25, 50, 100, 200], up: 0, c: 'var(--c-special)', g: '6/1' },
    { t: 'e', n: 'SORTE OU<br>REVÉS', g: '5/1' },
    { t: 'p', n: 'Sushi Nobú Prime', pr: 350, al: [35, 175, 500, 1100], up: 200, c: 'var(--c-blue)', g: '4/1' },
    { t: 'x', n: 'Imposto Luxo', val: 100, g: '3/1' },
    { t: 'p', n: 'Lassai', pr: 400, al: [50, 200, 600, 1400], up: 200, c: 'var(--c-blue)', g: '2/1' }
  ];

 const sorteRevesCartas = [
  { t: 'g', v: 150, d: "O crítico Michelin elogiou seu prato! Receba $150." },
  { t: 'g', v: 200, d: "Um influenciador famoso comeu no seu restaurante. +$200." },
  { t: 'g', v: 300, d: "Você ganhou o prêmio de Melhor Chef do Ano! +$300." },
  { t: 'g', v: 250, d: "Seu prato viralizou no TikTok! Faturamento bombou: +$250." },
  { t: 'g', v: 100, d: "Você reduziu o desperdício de alimentos. Economizou $100." },
  { t: 'g', v: 180, d: "Seu restaurante saiu na capa da revista gastronômica. +$180." },
  { t: 'g', v: 220, d: "Você fechou evento corporativo exclusivo. +$220." },
  { t: 'g', v: 120, d: "Fim de semana lotado no delivery. +$120." },
  { t: 'g', v: 350, d: "Um investidor decidiu apostar no seu negócio! +$350." },
  { t: 'g', v: 275, d: "Seu restaurante virou ponto turístico da cidade! +$275." },
  { t: 'g', v: 500, d: "Avaliação 5 estrelas em todas as plataformas! +$500." },
  { t: 'g', v: 90, d: "Parceria com aplicativo de entrega rendeu bônus. +$90." },
  { t: 'l', v: 100, d: "Sua cozinha pegou fogo e você perdeu ingredientes. Pague $100." },
  { t: 'l', v: 150, d: "Fiscalização encontrou produtos vencidos! Multa de $150." },
  { t: 'l', v: 200, d: "Um cliente processou você por intoxicação alimentar. Pague $200." },
  ...
  { t: 'l', v: 300, d: "Praga atingiu seu estoque orgânico. -$300." },
  { t: 'l', v: 80, d: "Multa por atraso no pagamento do gás. -$80." },
  { t: 'l', v: 220, d: "Concorrente abriu promoção agressiva. -$220." },
  { t: 'l', v: 400, d: "Processo trabalhista inesperado. -$400." },
  { t: 'l', v: 160, d: "Equipamento industrial quebrou. -$160." },
  { t: 'l', v: 130, d: "Avaliações negativas reduziram seu faturamento. -$130." }
];

const globalEvents = [
  {
    n: "Feriado Nacional!",
    d: "As ruas estão lotadas. Todos os jogadores ganham $150!",
    eff: (p) => p.money += 150
  },
  {
    n: "Crise Hídrica",
    d: "Falta de água na cidade. Todos perdem $100.",
    eff: (p) => { p.money -= 100; checkBankruptcy(p); }
  },
  {
    n: "Incentivo do Governo",
    d: "A prefeitura liberou auxílio para comerciantes! Todos ganham $200!",
    eff: (p) => p.money += 200
  },
  {
    n: "Apagão Geral",
  ...
  {
    n: "Festival Gastronômico",
    d: "Evento culinário movimentou a cidade! Todos ganham $250!",
    eff: (p) => p.money += 250
  },
  {
    n: "Alta no Preço dos Insumos",
  ...
  {
    n: "Fiscalização Intensiva",
    d: "Nova onda de inspeções sanitárias. Todos pagam $120.",
    eff: (p) => { p.money -= 120; checkBankruptcy(p); }
  },
  {
    n: "Programa de TV Culinário",
    d: "Reality show gastronômico movimentou o setor! Todos ganham $300!",
    eff: (p) => p.money += 300
  },
  {
    n: "Recessão Econômica",
...
const individualEvents = [
  {
    n: "Cliente VIP",
    d: "Um milionário adorou sua cozinha! +$300.",
    eff: (p) => p.money += 300
  },
  {
    n: "Chef Inspirado",
    d: "Você criou um prato exclusivo! +$250.",
    eff: (p) => p.money += 250
  },
  {
    n: "Equipamento Quebrado",
    d: "Seu forno industrial queimou. -$200.",
    eff: (p) => { p.money -= 200; checkBankruptcy(p); }
  },
  {
    n: "Roubo no Caixa",
    d: "Desvio interno detectado. -$150.",
    eff: (p) => { p.money -= 150; checkBankruptcy(p); }
  },
  {
    n: "Contrato Corporativo",
    d: "Você fechou contrato fixo mensal! +$400.",
    eff: (p) => p.money += 400
  },
  {
    n: "Avaliação Negativa Viral",
    d: "Review negativa espalhou na internet. -$250.",
    eff: (p) => { p.money -= 250; checkBankruptcy(p); }
  }
];
  const colors = ['var(--c-p1)', 'var(--c-p2)', 'var(--c-p3)', 'var(--c-p4)', 'var(--c-p5)', 'var(--c-p6)'];
  const upN = ['Reforma Básica', 'Cozinha Premium', 'Estrela Michelin 🌟'];

  let myAv = '👨‍🍳', myName = 'Magnata', myId = null, isHost = false, peer = null, conns = [], roomId = '', rPass = '';
  ...
  function joinRoom() {
    ...
    if (raw.length < 1) return alert("Digite um código válido.");
    roomId = raw;
    ...
    connectTimeout = setTimeout(() => {
      alert("Império não encontrado ou a conexão falhou.");
      uiBack();
    }, 8000);
  }
  ...
  function initPeer(idStr) {
    ...
    peer.on('error', err => {
      ...
      if (connectTimeout) clearTimeout(connectTimeout);
      if (err.type === 'peer-unavailable') alert('Sala inexistente ou código incorreto!');
  ...
  function setupConn(conn) {
    ...
    conn.on('close', () => {
      if (isHost) {
        ...
        alert("Conexão perdida com Host.");
        uiBack();
      }
    });
  }
  ...
  function hostStartGame() {
    if (gs.ps.length < 2) return alert('Mín. 2 investidores.');
    gs.st = 'IDLE';
    ...
    if (c.t === 'p') {
      ...
      if (!pr.dono) {
        if (p.money >= c.pr) {
          ...
          showM('Sem Capital', `Você não possui $${c.pr} para <b>${c.n}</b>.`, ['Compreendido']);
        }
      } else if (pr.dono === p.id) {
        if (pr.lvl < 3 && c.up > 0 && p.money >= c.up) {
          showM('Melhoria', `Evoluir para <b>${upN[pr.lvl]}</b> por $${c.up}?<br><br>Aluguel: $${c.al[pr.lvl]} ➔ $${c.al[pr.lvl + 1]}`, ['Investir', 'Não Agora']);
        } else if (pr.lvl === 3) {
          showM('Chef Supremo', `<b>${c.n}</b> atingiu o ápice com 3 Estrelas Michelin!`, ['Incrível']);
        } else {
          nextTurn();
        }
      } else {
      ...
      if (ev.t === 'g') {
        ...
        pagar(p, null, ev.v, `Revés<br><br>${ev.d}`);
      }
    } else if (c.n === 'Inspeção') {
      p.pos = 10;
      p.inJail = true;
      showM('Interditado', 'Vigilância lacrou tudo. Você foi conduzido.', ['Aceitar']);
    } else {
      nextTurn();
    }
  }
  ...
  function pagar(pag, rec, v, mot) {
    if (pag.money >= v) {
      pag.money -= v;
      if (rec) rec.money += v;
      showM(rec ? 'Acerto' : 'Dedução', `${mot}<br><br><b>Débito: $${v}</b>`, ['Pagar']);
    } else {
      showM('FALÊNCIA', `Faltou liquidez para cobrir $${v}!`, ['Falir']);
    }
  }
  ...
  function handleModalAction(p, i) {
    ...
    if (m.t === 'Vigilância Sanitária' && i === 0) {
      p.money -= 50;
      p.inJail = false;
    }
    if (pass) nextTurn();
  ...
  function nextTurn() {
    ...
    if (Math.random() < 0.2) {
        const currentPlayer = gs.ps[gs.turn];

        if (!currentPlayer.faliu) {
            const evt = individualEvents[Math.floor(Math.random() * individualEvents.length)];

            evt.eff(currentPlayer);

            showM(evt.n, evt.d, ['Continuar']);
        }
    }
    do {
  ...
  function render() {
    ...
    gs.props.forEach((pr, i) => {
      ...
      document.getElementById(`s-${i}`).innerHTML = '★'.repeat(pr.lvl);
    });
